...
const maskGroups=new Map();let currentMask='base';
...
function buildMaskAccessories(box,size,center){
  maskRoot.clear();maskGroups.clear();
...
function buildLayers(){
  baseMeshes.forEach((base,index)=>{
    ...
    const low=buildClusteredSkin(base,{portrait:portraitLayout(),excludedSurface,logLabel:'FaceKit Lab 19'});
...
updateLightUI();updateLayerUI();setMask('base',false);boot();animate();