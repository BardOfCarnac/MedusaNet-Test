...
// Lab 18 lighting is part of the actual scene, not an external patch.
...
function buildLayers(){
  baseMeshes.forEach((base,index)=>{
    ...
    const low=buildClusteredSkin(base,{portrait:portraitLayout(),excludedSurface,logLabel:'FaceKit Lab 18'});
...
updateLightUI();updateLayerUI();boot();animate();